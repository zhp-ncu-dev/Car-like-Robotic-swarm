/*
 ...
 [begin_description]
 Algebra for boost::array. Highly specialized for odeint. Const arguments are
 introduce to work with odeint. [end_description]
...
struct array_algebra {
  ...
  static void for_each1(boost::array<T, dim> &s1, Op op) {
    for (size_t i = 0; i < dim; ++i) op(s1[i]);
  }
  ...
  static void for_each2(boost::array<T1, dim> &s1,
    ...
    for (size_t i = 0; i < dim; ++i) op(s1[i], s2[i]);
  }
  ...
  static void for_each3(boost::array<T, dim> &s1,
    ...
    for (size_t i = 0; i < dim; ++i) op(s1[i], s2[i], s3[i]);
  }
  ...
  static void for_each4(boost::array<T, dim> &s1,
    ...
    for (size_t i = 0; i < dim; ++i) op(s1[i], s2[i], s3[i], s4[i]);
  }
  ...
  static void for_each5(boost::array<T, dim> &s1,
    ...
    for (size_t i = 0; i < dim; ++i) op(s1[i], s2[i], s3[i], s4[i], s5[i]);
  }
  ...
  static void for_each8(
      boost::array<T, dim> &s1, const boost::array<T, dim> &s2,
