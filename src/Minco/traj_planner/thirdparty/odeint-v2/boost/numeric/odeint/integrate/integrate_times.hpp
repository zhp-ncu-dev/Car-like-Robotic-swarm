...
size_t integrate_times(Stepper stepper, System system, State &start_state,
  ...
  return detail::integrate_times(stepper, system, start_state, times_start,
                                 times_end, dt, observer,
 ...
 */
template <class Stepper, class System, class State, class TimeRange, class Time,
          class Observer>
size_t integrate_times(Stepper stepper, System system, State &start_state,
                       const TimeRange &times, Time dt, Observer observer) {
  return integrate_times(stepper, system, start_state, boost::begin(times),
                         boost::end(times), dt, observer);
}
...
/**
 * \fn size_t integrate_times( Stepper stepper , System system , State
 * &start_state , TimeIterator times_start , TimeIterator times_end , Time dt ,
 * Observer observer ) \brief Integrates the ODE with observer calls at given
 * time points.
 *
