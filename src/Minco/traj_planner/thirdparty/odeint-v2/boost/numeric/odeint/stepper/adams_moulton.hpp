/*
 ...
 [begin_description]
 Implementation of the Adams-Moulton method. This is method is not a real
 stepper, it is more a helper class which computes the corrector step in the
 Adams-Bashforth-Moulton method. [end_description]
...
/*
 * Static implicit Adams-Moulton multistep-solver without step size control and
...
class adams_moulton {
 ...
 public:
  ...
  typedef adams_moulton<Steps, State, Value, Deriv, Time, Algebra, Operations,
                        Resizer>
      stepper_type;
  ...
  template <class System, class StateInOut, class ABBuf>
  void do_step(System system, const StateInOut &in, time_type t, time_type dt,
               const ABBuf &buf) {
    do_step(system, in, t, in, dt, buf);
  }
