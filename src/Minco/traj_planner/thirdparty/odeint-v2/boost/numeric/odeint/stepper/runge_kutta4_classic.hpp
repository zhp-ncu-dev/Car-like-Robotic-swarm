...
class runge_kutta4_classic
    : public explicit_stepper_base<
          runge_kutta4_classic<State, Value, Deriv, Time, Algebra, Operations,
                               Resizer>,
...
#endif
{
 ...
 public:
  ...
  typedef explicit_stepper_base<
      ...
      stepper_base_type;
#else
  typedef explicit_stepper_base<runge_kutta4_classic<...>, ...>
      stepper_base_type;
#endif
 ...
 private:
  ...
  bool resize_impl(const StateIn &x) {
    ...
    resized |= adjust_size_by_resizeability(
        m_dxm, x, typename is_resizeable<deriv_type>::type());
    resized |= adjust_size_by_resizeability(
        m_dxt, x, typename is_resizeable<deriv_type>::type());
    resized |= adjust_size_by_resizeability(
        m_dxh, x, typename is_resizeable<deriv_type>::type());
    return resized;
  }
 ...
 * or continuous output are not provided.  This class implements the method
 * directly, hence the generic Runge-Kutta algorithm is not used.
 *
 ...
 * \brief Constructs the runge_kutta4_classic class. This constructor can be
...
/**
 * \fn runge_kutta4_classic::do_step_impl( System system , const StateIn &in ,
