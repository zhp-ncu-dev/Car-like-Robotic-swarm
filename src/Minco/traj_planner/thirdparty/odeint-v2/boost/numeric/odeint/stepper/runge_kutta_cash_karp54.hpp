/*
 ...
 [begin_description]
 Implementation of the Runge Kutta Cash Karp 5(4) method. It uses the generic
 error stepper. [end_description]
...
class runge_kutta_cash_karp54
    : public explicit_error_generic_rk<6, 5, 5, 4, State, Value, Deriv, Time,
...
/**
 * \fn runge_kutta_cash_karp54::runge_kutta_cash_karp54( const algebra_type
 * &algebra ) \brief Constructs the runge_kutta_cash_karp54 class. This
