...
size_t integrate_adaptive(Stepper stepper, System system, State &start_state,
   ...
   *
   * integrator_adaptive< Stepper , System, State , Time , Observer , typename
   * Stepper::stepper_category > integrator; return integrator.run( stepper ,
   * system , start_state , start_time , end_time , dt , observer );
   */
}
...
size_t integrate_adaptive(Stepper stepper, System system, State &start_state,
                          Time start_time, Time end_time, Time dt) {
  return integrate_adaptive(stepper, system, start_state, start_time, end_time,
                            dt, null_observer());
}
...
/**
 * \fn integrate_adaptive( Stepper stepper , System system , State &start_state
