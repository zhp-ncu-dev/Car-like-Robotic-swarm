...
#endif
{
 ...
 public:
#ifndef DOXYGEN_SKIP
  typedef explicit_generic_rk<4, 4, State, Value, Deriv, Time, Algebra,
                              Operations, Resizer>
      stepper_base_type;
#endif
  ...
  runge_kutta4(const algebra_type &algebra = algebra_type())
      : stepper_base_type(
            boost::fusion::make_vector(rk4_coefficients_a1<Value>(),
 ...
 * CRTP (current recurring template pattern). Furthermore, it derivs from
 * explicit_generic_rk which is a generic Runge-Kutta algorithm. For more
 * details see explicit_stepper_base and explicit_generic_rk.
 *
 ...
 * ) \brief Constructs the runge_kutta4 class. This constructor can be used as a
