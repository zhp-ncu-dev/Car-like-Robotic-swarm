/* [auto_generated]
 ...
 [begin_description]
 The default controlled stepper which can be used with all explicit Runge-Kutta
...
template <class Value, class Algebra = range_algebra,
...
class controlled_runge_kutta<ErrorStepper, ErrorChecker, Resizer,
 ...
 public:
  ...
  typedef controlled_runge_kutta<ErrorStepper, ErrorChecker, Resizer,
                                 explicit_error_stepper_tag>
  ...
  controlled_step_result try_step(System system, StateInOut &x,
    ...
    m_xnew_resizer.adjust_size(
        x, detail::bind(
               &controlled_runge_kutta::template resize_m_xnew_impl<StateInOut>,
  ...
  try_step(System system, const StateIn &in, time_type &t, StateOut &out,
    ...
    m_dxdt_resizer.adjust_size(
        in, detail::bind(
                &controlled_runge_kutta::template resize_m_dxdt_impl<StateIn>,
                detail::ref(*this), detail::_1));
    sys(in, m_dxdt.m_v, t);
  ...
  controlled_step_result try_step(System system, const StateIn &in,
    ...
    m_xerr_resizer.adjust_size(
        in, detail::bind(
                &controlled_runge_kutta::template resize_m_xerr_impl<StateIn>,
                detail::ref(*this), detail::_1));
 ...
 private:
  ...
  controlled_step_result try_step_v1(System system, StateInOut &x, time_type &t,
    ...
    m_dxdt_resizer.adjust_size(
        x, detail::bind(
               &controlled_runge_kutta::template resize_m_dxdt_impl<StateInOut>,
               detail::ref(*this), detail::_1));
    sys(x, m_dxdt.m_v, t);
...
class controlled_runge_kutta<ErrorStepper, ErrorChecker, Resizer,
 ...
 public:
  ...
  controlled_step_result try_step(System system, StateInOut &x,
    ...
    m_dxdt_new_resizer.adjust_size(
        x,
        detail::bind(&controlled_runge_kutta::template resize_m_dxdt_new_impl<
                         StateInOut>,
                     detail::ref(*this), detail::_1));
 ...
 private:
  ...
  controlled_step_result try_step_v1(System system, StateInOut &x, time_type &t,
    ...
    if (m_dxdt_resizer.adjust_size(
            x,
            detail::bind(&controlled_runge_kutta::template resize_m_dxdt_impl<
                             StateInOut>,
                         detail::ref(*this), detail::_1)) ||
        m_first_call) {
